...
dialog.add(sYou, character1Name + lineBreak + "Space influencing people...? I don't know if I buy that. I mean, spaces don't breathe or feel emotions, right? But we do - we're living, emotional beings.");
dialog.add(sRoomate, character2Name + lineBreak + "Hmm...!!! I think it makes sense, though. Just look at that... something's glowing over there!");
...
dialog.add(sRoomate, character2Name + lineBreak + "No idea, but it looks like something fun is about to happen. Prof. K was right - just that glow alone makes the space feel...inviting, almost magnetic!");
