...
dialog.add(sDemon3, character3Name + lineBreak + "Hah. It's probably just some weird spirit in disguise. No way we actually summoned a real human.");
dialog.add(sDemon2, character4Name + lineBreak + "But look! It has skin, and...hair! And - wait, its eyes are staring at us! That's definitely human!");
...
dialog.add(sDemon3, character3Name + lineBreak + "Yeah, you should feel honored. We've never met a real human before. You're basically a walking legend.");
dialog.add(sYou, character1Name + lineBreak + "Lucky me...Now, mind telling me why I'm here?");
dialog.add(sDemon2, character4Name + lineBreak + "We might have performed a summoning ritual. Just, you know...for fun. It wasn't supposed to actually work!");
...
dialog.add(sDemon2, character3Name + lineBreak + "Let's play hide and seek! Find us and answer the questions to get rewards.");

dialog.add(sDemon3, character3Name + lineBreak + "But the first lesson is paying attention to the demon cops. They don't welcome any outsiders.");
dialog.add(sYou, character1Name + lineBreak + "What does that mean?");
dialog.add(sDemon2, character4Name + lineBreak + "Never mind. He was just giving you a friendly reminder. If you get caught by cops, there's no way to go back.");
